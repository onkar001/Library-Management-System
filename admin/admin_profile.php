...
$query=mysqli_query($con,"SELECT * FROM admin_data where id='$admin_id'")or die(mysqli_error());
      ...
      <div class="col-lg-8 col-xl-6">
        <div class="card rounded-3">
          ...
          <div class="card-body p-4 p-md-5">
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Admin Profile </h3>

            <form class="px-md-2" method="post" action='admin_code.php'>
